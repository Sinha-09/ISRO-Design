...
if(isset($_POST['login']))
{
	$usname=$_POST['usname'];
	$pswrd=$_POST['pswrd'];
	$cmd="select * from managertab where username='$usname' and password='$pswrd'";
...
<div class="container">
  ...
  <form action="managerlogin.php" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="uname" placeholder="Enter username" name="usname">
     
    </div>
    <div class="form-group">
      <label for="pwd">Password:</label>
      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pswrd">
